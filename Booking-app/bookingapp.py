...
if selected == "Home":
    ...
    with st.container():
        ...
        #  content to be show when user get logged in and chooses  destination
        with st.container():
            if button_value == True and st.session_state.showfurcont == True:
                st.session_state.showfurcont = True
                    ...
                    with st.form("indigo passenger form"):
                        ...
                        if submitpassform:
                            if passfirstname == '' or passlastname == ''  or passemail == '':
                                ...
                                st.session_state.showindpay = True
                                qry = '''
                                INSERT INTO passengers(firstname, lastname, aadharno, email, time, class, date, fromdest, todest, airline, username )
                                VALUES("{}","{}","{}","{}","{}","{}","{}","{}","{}","{}","{}")
                                '''.format(passfirstname,passlastname,passadharno, passemail,st.session_state['indtime'],st.session_state['class'],st.session_state['date'],st.session_state['from'],st.session_state['to'], airlineopt , st.session_state['username'] )
                ...
                if st.session_state.showindpay == True:
                    ...
                    if payopt == "Credit":
                        ...
                        if paybtn or st.session_state.indpaydone == True:
                            ...
                            createticket(airlineopt,name,st.session_state['from'],st.session_state['to'], st.session_state['date'], st.session_state['indtime'],st.session_state['class'],passadharno+passfirstname)
                        ...
                        st.success("Option not available please proceeds with Credit or make payment at airport")
...
# spicejet form
                    ...
                    with st.form("spicejet passenger form", clear_on_submit=True):
                        ...
                        if submitpassform:
                            if passfirstname == '' or passlastname == ''  or passemail == '':
                                ...
                                INSERT INTO passengers(firstname, lastname, aadharno, email, time, class, date, fromdest, todest, airline, username )
                                VALUES("{}","{}","{}","{}","{}","{}","{}","{}","{}","{}","{}")
                                '''.format(passfirstname,passlastname,passadharno, passemail,st.session_state['spitime'],st.session_state['class'],st.session_state['date'],st.session_state['from'],st.session_state['to'],airlineopt, st.session_state['username'] )
                ...
                if st.session_state.showspipay == True:
                    ...
                    if payopt == "Credit":
                        ...
                        if sppaybtn or st.session_state.spipaydone == True:
                            st.title("Download ticket")
                            createticket(airlineopt,name,st.session_state['from'],st.session_state['to'], st.session_state['date'], st.session_state['spitime'],st.session_state['class'],passadharno+passfirstname)
                            ticket = 'passengerstickets/'+passadharno+passfirstname+'.pdf'
                            with open(ticket,'rb') as file:
                                pdfbytes = file.read()
